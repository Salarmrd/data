  ...
  return (
    <div >
      ...
      className='md:text-5xl sm:text-4xl text-xl font-bold pl-1 '/>
        ...
        <p className='mt-5 md:text-2xl text-xl font-bold text-gray-400'>Monitor your data analytics to increase revenue for BTB, BTC, &  SASSS platform.</p>
        <button className='bg-[#00df9a] w-[200px] rounded mx-auto py-1 px-5 mt-4 text-black font-medium'>Get started</button>
        </div>
