...
const Navbar = () => {
  ...
  return (
    <nav className='flex items-center justify-between mx-auto max-w-[1240px] h-20 px-4'>
        ...
        <li className='p-4'>Contact</li></ul>
        <div onClick={handleMenu} className='md:hidden'>{!nav ? <AiOutlineClose size={20}/> : <AiOutlineMenu size={20}/>}</div>
        <div className={!nav ? 'fixed bg-[#000300] left-0 top-0 w-[60%] h-full border-r border-r-gray-900 ease-in-out duration-500' : "fixed left-[-100%]"}>
